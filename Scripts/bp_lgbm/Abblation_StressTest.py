...
if __name__ == "__main__":
    ...
    df_test = preprocessing.downsample_per_patient(df_test, patient_col="Subject", proportion = 0.34)
    print(df_test.info())
    ...
    cfg = ExperimentConfig(n_splits=5,
                           random_state=42, 
                           experiment_name="Abblation_stress",
                           verbose = -1,
    ...
    for target in targets:
        ...
        # Eval
        Path_res = ABBLATION_RESULTS_PAPER / r"Stress_Reduced_Testing"
        ...
        results = {
            "Train": metrics_train,
            "Val": metrics_val,
            "Test_original_subsampled": metrics_test_original,
