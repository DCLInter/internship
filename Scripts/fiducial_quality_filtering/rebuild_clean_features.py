...
from an old cache), this will faithfully reproduce that staleness. See
README.txt / ASSUMPTIONS.txt for when the cache and sweep JSONs were last
built vs. when run_pipeline.py's config last changed.
